...
(function() {
   ...
   // Create init users.
   var nasaa ={_id:"216512318qe156489711006",first_name:"Nasanjargal",last_name:"nasaa",
               location:"Mongolia UB",description:"My name is Hajidsuren",occupation:"hajidsuren"};
   ...
   var users = [Nasaa,im, er, pt, rk, al, jo];
